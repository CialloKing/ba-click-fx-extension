...
- Visual preferences—including enabled states, color, opacity, scale, quality, language, and motion choices—are saved with the browser-provided `storage.sync` API.
