...
The prepared build uses `ba-click-fx 1.2.19`, adds full WebGL2 rendering, and exposes the complete 65-parameter upstream Schema without changing permissions or network behavior.
