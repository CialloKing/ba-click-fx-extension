...
Firefox is intentionally outside the `1.0.5` Chromium store package and remains planned for extension `v1.0.6`. Do not upload the Chromium ZIP to AMO without completing and testing a separate build.
...
- verify both sync/local storage areas, schema-v2 migration, active-tab messaging, options-page locale selection, reduced motion, closed Shadow DOM, and pointer behavior in Firefox;
