...
Historical record retained from the original checklist. Its completed checks and runtime report apply only to that recorded release. Use the [current release template](../release-checklist.md) for subsequent releases.
