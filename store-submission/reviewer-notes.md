...
6. Select “Full settings”. Change the appearance preset, experimental WebGPU HDR, full WebGL2 or fallback render mode, maximum DPR, output compositing, light-background contrast, timing, or one of the 65 advanced effect parameters and verify the webpage updates.
...
6. 打开“完整设置”，修改预设、实验性 WebGPU HDR、完整 WebGL2 或回退渲染模式、最大 DPR、输出合成、浅色背景对比、时间倍率，或 65 个高级特效参数中的任意一项，确认网页效果更新。
